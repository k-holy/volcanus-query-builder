...
class MysqlParameterBuilderTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testToTimestampArrayOfString()
    {
        ...
        $this->assertEquals("STR_TO_DATE('2013-01-02 03:04:05', '%Y-%m-%d %H:%i:%s')", $builder->toTimestamp(array(
            '2013',
            '01',
            '02',
            '03',
    ...
    public function testToGeometryFromArrayOfString()
    {
        ...
        $this->assertEquals("GeomFromText('POINT(139.744858 35.675888)')", $builder->toGeometry(array(
            '139.744858',
            '35.675888',
        )));
    }
